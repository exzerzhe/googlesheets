...
const CLIENT_ID =
  "457989737322-cqvilvcbllb6tu25adi54pregtl5qgsr.apps.googleusercontent.com"; //from https://console.developers.google.com/apis/credentials
...
export default class ContactForm extends React.Component {
  ...
  onFormSubmit() {
    ...
    request.then(
      ...
      function (reason) {
        alert("Кажется ошибка: " + reason.result.error.message);
        arr = [];
      }
    );
  ...
  render() {
    return (
      <div style={{ textAlign: "center" }}>
        ...
        {this.state.loading ? (
          <div style={{ marginTop: 50 }}>Заполняю таблицу...</div>
        ) : null}
